...
void
yp_serialize_node(yp_parser_t *parser, yp_node_t *node, yp_buffer_t *buffer, bool include_location_fields) {
    ...
    switch (YP_NODE_TYPE(node)) {
        ...
        case YP_ALIAS_GLOBAL_VARIABLE_NODE: {
            yp_serialize_node(parser, (yp_node_t *)((yp_alias_global_variable_node_t *)node)->new_name, buffer, include_location_fields);
            yp_serialize_node(parser, (yp_node_t *)((yp_alias_global_variable_node_t *)node)->old_name, buffer, include_location_fields);
        ...
        case YP_ALIAS_METHOD_NODE: {
            yp_serialize_node(parser, (yp_node_t *)((yp_alias_method_node_t *)node)->new_name, buffer, include_location_fields);
            yp_serialize_node(parser, (yp_node_t *)((yp_alias_method_node_t *)node)->old_name, buffer, include_location_fields);
            if (include_location_fields) {
        ...
        case YP_ALTERNATION_PATTERN_NODE: {
            yp_serialize_node(parser, (yp_node_t *)((yp_alternation_pattern_node_t *)node)->left, buffer, include_location_fields);
            yp_serialize_node(parser, (yp_node_t *)((yp_alternation_pattern_node_t *)node)->right, buffer, include_location_fields);
            if (include_location_fields) {
        ...
        case YP_AND_NODE: {
            yp_serialize_node(parser, (yp_node_t *)((yp_and_node_t *)node)->left, buffer, include_location_fields);
            yp_serialize_node(parser, (yp_node_t *)((yp_and_node_t *)node)->right, buffer, include_location_fields);
            if (include_location_fields) {
        ...
        case YP_ARGUMENTS_NODE: {
            ...
            for (uint32_t index = 0; index < arguments_size; index++) {
                yp_serialize_node(parser, (yp_node_t *) ((yp_arguments_node_t *)node)->arguments.nodes[index], buffer, include_location_fields);
            }
            break;
        }
        case YP_ARRAY_NODE: {
            ...
            for (uint32_t index = 0; index < elements_size; index++) {
                yp_serialize_node(parser, (yp_node_t *) ((yp_array_node_t *)node)->elements.nodes[index], buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_ARRAY_PATTERN_NODE: {
            if (((yp_array_pattern_node_t *)node)->constant == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_array_pattern_node_t *)node)->constant, buffer, include_location_fields);
            }
            ...
            for (uint32_t index = 0; index < requireds_size; index++) {
                yp_serialize_node(parser, (yp_node_t *) ((yp_array_pattern_node_t *)node)->requireds.nodes[index], buffer, include_location_fields);
            }
            if (((yp_array_pattern_node_t *)node)->rest == NULL) {
                yp_buffer_append_u8(buffer, 0);
            } else {
                yp_serialize_node(parser, (yp_node_t *)((yp_array_pattern_node_t *)node)->rest, buffer, include_location_fields);
            }
            ...
            for (uint32_t index = 0; index < posts_size; index++) {
                yp_serialize_node(parser, (yp_node_t *) ((yp_array_pattern_node_t *)node)->posts.nodes[index], buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_ASSOC_NODE: {
            yp_serialize_node(parser, (yp_node_t *)((yp_assoc_node_t *)node)->key, buffer, include_location_fields);
            if (((yp_assoc_node_t *)node)->value == NULL) {
                yp_buffer_append_u8(buffer, 0);
            } else {
                yp_serialize_node(parser, (yp_node_t *)((yp_assoc_node_t *)node)->value, buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_ASSOC_SPLAT_NODE: {
            if (((yp_assoc_splat_node_t *)node)->value == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_assoc_splat_node_t *)node)->value, buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_BEGIN_NODE: {
            ...
            if (((yp_begin_node_t *)node)->statements == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_begin_node_t *)node)->statements, buffer, include_location_fields);
            }
            if (((yp_begin_node_t *)node)->rescue_clause == NULL) {
                yp_buffer_append_u8(buffer, 0);
            } else {
                yp_serialize_node(parser, (yp_node_t *)((yp_begin_node_t *)node)->rescue_clause, buffer, include_location_fields);
            }
            if (((yp_begin_node_t *)node)->else_clause == NULL) {
                yp_buffer_append_u8(buffer, 0);
            } else {
                yp_serialize_node(parser, (yp_node_t *)((yp_begin_node_t *)node)->else_clause, buffer, include_location_fields);
            }
            if (((yp_begin_node_t *)node)->ensure_clause == NULL) {
                yp_buffer_append_u8(buffer, 0);
            } else {
                yp_serialize_node(parser, (yp_node_t *)((yp_begin_node_t *)node)->ensure_clause, buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_BLOCK_ARGUMENT_NODE: {
            if (((yp_block_argument_node_t *)node)->expression == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_block_argument_node_t *)node)->expression, buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_BLOCK_NODE: {
            ...
            if (((yp_block_node_t *)node)->parameters == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_block_node_t *)node)->parameters, buffer, include_location_fields);
            }
            if (((yp_block_node_t *)node)->body == NULL) {
                yp_buffer_append_u8(buffer, 0);
            } else {
                yp_serialize_node(parser, (yp_node_t *)((yp_block_node_t *)node)->body, buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_BLOCK_PARAMETERS_NODE: {
            if (((yp_block_parameters_node_t *)node)->parameters == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_block_parameters_node_t *)node)->parameters, buffer, include_location_fields);
            }
            uint32_t locals_size = yp_sizet_to_u32(((yp_block_parameters_node_t *)node)->locals.size);
            yp_buffer_append_u32(buffer, locals_size);
            for (uint32_t index = 0; index < locals_size; index++) {
                yp_serialize_node(parser, (yp_node_t *) ((yp_block_parameters_node_t *)node)->locals.nodes[index], buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_BREAK_NODE: {
            if (((yp_break_node_t *)node)->arguments == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_break_node_t *)node)->arguments, buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_CALL_AND_WRITE_NODE: {
            if (((yp_call_and_write_node_t *)node)->receiver == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_call_and_write_node_t *)node)->receiver, buffer, include_location_fields);
            }
            if (include_location_fields) {
            ...
            if (((yp_call_and_write_node_t *)node)->arguments == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_call_and_write_node_t *)node)->arguments, buffer, include_location_fields);
            }
            if (include_location_fields) {
            ...
            yp_serialize_node(parser, (yp_node_t *)((yp_call_and_write_node_t *)node)->value, buffer, include_location_fields);
            break;
        }
        case YP_CALL_NODE: {
            if (((yp_call_node_t *)node)->receiver == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_call_node_t *)node)->receiver, buffer, include_location_fields);
            }
            if (include_location_fields) {
            ...
            if (((yp_call_node_t *)node)->arguments == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_call_node_t *)node)->arguments, buffer, include_location_fields);
            }
            if (include_location_fields) {
            ...
            if (((yp_call_node_t *)node)->block == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_call_node_t *)node)->block, buffer, include_location_fields);
            }
            yp_buffer_append_u32(buffer, node->flags >> 1);
        ...
        case YP_CALL_OPERATOR_WRITE_NODE: {
            if (((yp_call_operator_write_node_t *)node)->receiver == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_call_operator_write_node_t *)node)->receiver, buffer, include_location_fields);
            }
            if (include_location_fields) {
            ...
            if (((yp_call_operator_write_node_t *)node)->arguments == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_call_operator_write_node_t *)node)->arguments, buffer, include_location_fields);
            }
            if (include_location_fields) {
            ...
            yp_serialize_node(parser, (yp_node_t *)((yp_call_operator_write_node_t *)node)->value, buffer, include_location_fields);
            break;
        }
        case YP_CALL_OR_WRITE_NODE: {
            if (((yp_call_or_write_node_t *)node)->receiver == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_call_or_write_node_t *)node)->receiver, buffer, include_location_fields);
            }
            if (include_location_fields) {
            ...
            if (((yp_call_or_write_node_t *)node)->arguments == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_call_or_write_node_t *)node)->arguments, buffer, include_location_fields);
            }
            if (include_location_fields) {
            ...
            yp_serialize_node(parser, (yp_node_t *)((yp_call_or_write_node_t *)node)->value, buffer, include_location_fields);
            break;
        }
        case YP_CAPTURE_PATTERN_NODE: {
            yp_serialize_node(parser, (yp_node_t *)((yp_capture_pattern_node_t *)node)->value, buffer, include_location_fields);
            yp_serialize_node(parser, (yp_node_t *)((yp_capture_pattern_node_t *)node)->target, buffer, include_location_fields);
            if (include_location_fields) {
        ...
        case YP_CASE_NODE: {
            if (((yp_case_node_t *)node)->predicate == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_case_node_t *)node)->predicate, buffer, include_location_fields);
            }
            ...
            for (uint32_t index = 0; index < conditions_size; index++) {
                yp_serialize_node(parser, (yp_node_t *) ((yp_case_node_t *)node)->conditions.nodes[index], buffer, include_location_fields);
            }
            if (((yp_case_node_t *)node)->consequent == NULL) {
                yp_buffer_append_u8(buffer, 0);
            } else {
                yp_serialize_node(parser, (yp_node_t *)((yp_case_node_t *)node)->consequent, buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_CLASS_NODE: {
            ...
            yp_serialize_node(parser, (yp_node_t *)((yp_class_node_t *)node)->constant_path, buffer, include_location_fields);
            if (include_location_fields) {
            ...
            if (((yp_class_node_t *)node)->superclass == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_class_node_t *)node)->superclass, buffer, include_location_fields);
            }
            if (((yp_class_node_t *)node)->body == NULL) {
                yp_buffer_append_u8(buffer, 0);
            } else {
                yp_serialize_node(parser, (yp_node_t *)((yp_class_node_t *)node)->body, buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_CLASS_VARIABLE_AND_WRITE_NODE: {
            ...
            yp_serialize_node(parser, (yp_node_t *)((yp_class_variable_and_write_node_t *)node)->value, buffer, include_location_fields);
            break;
        }
        case YP_CLASS_VARIABLE_OPERATOR_WRITE_NODE: {
            ...
            yp_serialize_node(parser, (yp_node_t *)((yp_class_variable_operator_write_node_t *)node)->value, buffer, include_location_fields);
        ...
        case YP_CLASS_VARIABLE_OR_WRITE_NODE: {
            ...
            yp_serialize_node(parser, (yp_node_t *)((yp_class_variable_or_write_node_t *)node)->value, buffer, include_location_fields);
            break;
        }
        ...
        case YP_CLASS_VARIABLE_WRITE_NODE: {
            ...
            yp_serialize_node(parser, (yp_node_t *)((yp_class_variable_write_node_t *)node)->value, buffer, include_location_fields);
            if (include_location_fields) {
        ...
        case YP_CONSTANT_AND_WRITE_NODE: {
            ...
            yp_serialize_node(parser, (yp_node_t *)((yp_constant_and_write_node_t *)node)->value, buffer, include_location_fields);
            break;
        }
        case YP_CONSTANT_OPERATOR_WRITE_NODE: {
            ...
            yp_serialize_node(parser, (yp_node_t *)((yp_constant_operator_write_node_t *)node)->value, buffer, include_location_fields);
        ...
        case YP_CONSTANT_OR_WRITE_NODE: {
            ...
            yp_serialize_node(parser, (yp_node_t *)((yp_constant_or_write_node_t *)node)->value, buffer, include_location_fields);
            break;
        }
        case YP_CONSTANT_PATH_AND_WRITE_NODE: {
            yp_serialize_node(parser, (yp_node_t *)((yp_constant_path_and_write_node_t *)node)->target, buffer, include_location_fields);
            if (include_location_fields) {
                yp_serialize_location(parser, &((yp_constant_path_and_write_node_t *)node)->operator_loc, buffer);
            }
            yp_serialize_node(parser, (yp_node_t *)((yp_constant_path_and_write_node_t *)node)->value, buffer, include_location_fields);
            break;
        }
        case YP_CONSTANT_PATH_NODE: {
            if (((yp_constant_path_node_t *)node)->parent == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_constant_path_node_t *)node)->parent, buffer, include_location_fields);
            }
            yp_serialize_node(parser, (yp_node_t *)((yp_constant_path_node_t *)node)->child, buffer, include_location_fields);
            if (include_location_fields) {
        ...
        case YP_CONSTANT_PATH_OPERATOR_WRITE_NODE: {
            yp_serialize_node(parser, (yp_node_t *)((yp_constant_path_operator_write_node_t *)node)->target, buffer, include_location_fields);
            if (include_location_fields) {
                yp_serialize_location(parser, &((yp_constant_path_operator_write_node_t *)node)->operator_loc, buffer);
            }
            yp_serialize_node(parser, (yp_node_t *)((yp_constant_path_operator_write_node_t *)node)->value, buffer, include_location_fields);
        ...
        case YP_CONSTANT_PATH_OR_WRITE_NODE: {
            yp_serialize_node(parser, (yp_node_t *)((yp_constant_path_or_write_node_t *)node)->target, buffer, include_location_fields);
            if (include_location_fields) {
                yp_serialize_location(parser, &((yp_constant_path_or_write_node_t *)node)->operator_loc, buffer);
            }
            yp_serialize_node(parser, (yp_node_t *)((yp_constant_path_or_write_node_t *)node)->value, buffer, include_location_fields);
            break;
        }
        case YP_CONSTANT_PATH_TARGET_NODE: {
            if (((yp_constant_path_target_node_t *)node)->parent == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_constant_path_target_node_t *)node)->parent, buffer, include_location_fields);
            }
            yp_serialize_node(parser, (yp_node_t *)((yp_constant_path_target_node_t *)node)->child, buffer, include_location_fields);
            if (include_location_fields) {
        ...
        case YP_CONSTANT_PATH_WRITE_NODE: {
            yp_serialize_node(parser, (yp_node_t *)((yp_constant_path_write_node_t *)node)->target, buffer, include_location_fields);
            if (include_location_fields) {
                yp_serialize_location(parser, &((yp_constant_path_write_node_t *)node)->operator_loc, buffer);
            }
            yp_serialize_node(parser, (yp_node_t *)((yp_constant_path_write_node_t *)node)->value, buffer, include_location_fields);
            break;
        }
        ...
        case YP_CONSTANT_WRITE_NODE: {
            ...
            yp_serialize_node(parser, (yp_node_t *)((yp_constant_write_node_t *)node)->value, buffer, include_location_fields);
            if (include_location_fields) {
        ...
        case YP_DEF_NODE: {
            ...
            if (((yp_def_node_t *)node)->receiver == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_def_node_t *)node)->receiver, buffer, include_location_fields);
            }
            if (((yp_def_node_t *)node)->parameters == NULL) {
                yp_buffer_append_u8(buffer, 0);
            } else {
                yp_serialize_node(parser, (yp_node_t *)((yp_def_node_t *)node)->parameters, buffer, include_location_fields);
            }
            if (((yp_def_node_t *)node)->body == NULL) {
                yp_buffer_append_u8(buffer, 0);
            } else {
                yp_serialize_node(parser, (yp_node_t *)((yp_def_node_t *)node)->body, buffer, include_location_fields);
            }
        ...
        case YP_DEFINED_NODE: {
            ...
            yp_serialize_node(parser, (yp_node_t *)((yp_defined_node_t *)node)->value, buffer, include_location_fields);
            if (include_location_fields) {
        ...
        case YP_ELSE_NODE: {
            ...
            if (((yp_else_node_t *)node)->statements == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_else_node_t *)node)->statements, buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_EMBEDDED_STATEMENTS_NODE: {
            ...
            if (((yp_embedded_statements_node_t *)node)->statements == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_embedded_statements_node_t *)node)->statements, buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_EMBEDDED_VARIABLE_NODE: {
            ...
            yp_serialize_node(parser, (yp_node_t *)((yp_embedded_variable_node_t *)node)->variable, buffer, include_location_fields);
            break;
        }
        case YP_ENSURE_NODE: {
            if (include_location_fields) {
            ...
            if (((yp_ensure_node_t *)node)->statements == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_ensure_node_t *)node)->statements, buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_FIND_PATTERN_NODE: {
            if (((yp_find_pattern_node_t *)node)->constant == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_find_pattern_node_t *)node)->constant, buffer, include_location_fields);
            }
            yp_serialize_node(parser, (yp_node_t *)((yp_find_pattern_node_t *)node)->left, buffer, include_location_fields);
            uint32_t requireds_size = yp_sizet_to_u32(((yp_find_pattern_node_t *)node)->requireds.size);
            yp_buffer_append_u32(buffer, requireds_size);
            for (uint32_t index = 0; index < requireds_size; index++) {
                yp_serialize_node(parser, (yp_node_t *) ((yp_find_pattern_node_t *)node)->requireds.nodes[index], buffer, include_location_fields);
            }
            yp_serialize_node(parser, (yp_node_t *)((yp_find_pattern_node_t *)node)->right, buffer, include_location_fields);
            if (include_location_fields) {
        ...
        case YP_FLIP_FLOP_NODE: {
            if (((yp_flip_flop_node_t *)node)->left == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_flip_flop_node_t *)node)->left, buffer, include_location_fields);
            }
            if (((yp_flip_flop_node_t *)node)->right == NULL) {
                yp_buffer_append_u8(buffer, 0);
            } else {
                yp_serialize_node(parser, (yp_node_t *)((yp_flip_flop_node_t *)node)->right, buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_FOR_NODE: {
            yp_serialize_node(parser, (yp_node_t *)((yp_for_node_t *)node)->index, buffer, include_location_fields);
            yp_serialize_node(parser, (yp_node_t *)((yp_for_node_t *)node)->collection, buffer, include_location_fields);
            if (((yp_for_node_t *)node)->statements == NULL) {
                yp_buffer_append_u8(buffer, 0);
            } else {
                yp_serialize_node(parser, (yp_node_t *)((yp_for_node_t *)node)->statements, buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_FORWARDING_SUPER_NODE: {
            if (((yp_forwarding_super_node_t *)node)->block == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_forwarding_super_node_t *)node)->block, buffer, include_location_fields);
            }
            break;
        }
        case YP_GLOBAL_VARIABLE_AND_WRITE_NODE: {
            ...
            yp_serialize_node(parser, (yp_node_t *)((yp_global_variable_and_write_node_t *)node)->value, buffer, include_location_fields);
            break;
        }
        case YP_GLOBAL_VARIABLE_OPERATOR_WRITE_NODE: {
            ...
            yp_serialize_node(parser, (yp_node_t *)((yp_global_variable_operator_write_node_t *)node)->value, buffer, include_location_fields);
        ...
        case YP_GLOBAL_VARIABLE_OR_WRITE_NODE: {
            ...
            yp_serialize_node(parser, (yp_node_t *)((yp_global_variable_or_write_node_t *)node)->value, buffer, include_location_fields);
            break;
        }
        ...
        case YP_GLOBAL_VARIABLE_WRITE_NODE: {
            ...
            yp_serialize_node(parser, (yp_node_t *)((yp_global_variable_write_node_t *)node)->value, buffer, include_location_fields);
            if (include_location_fields) {
        ...
        case YP_HASH_NODE: {
            ...
            yp_buffer_append_u32(buffer, elements_size);
            for (uint32_t index = 0; index < elements_size; index++) {
                yp_serialize_node(parser, (yp_node_t *) ((yp_hash_node_t *)node)->elements.nodes[index], buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_HASH_PATTERN_NODE: {
            if (((yp_hash_pattern_node_t *)node)->constant == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_hash_pattern_node_t *)node)->constant, buffer, include_location_fields);
            }
            ...
            for (uint32_t index = 0; index < assocs_size; index++) {
                yp_serialize_node(parser, (yp_node_t *) ((yp_hash_pattern_node_t *)node)->assocs.nodes[index], buffer, include_location_fields);
            }
            if (((yp_hash_pattern_node_t *)node)->kwrest == NULL) {
                yp_buffer_append_u8(buffer, 0);
            } else {
                yp_serialize_node(parser, (yp_node_t *)((yp_hash_pattern_node_t *)node)->kwrest, buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_IF_NODE: {
            ...
            yp_serialize_node(parser, (yp_node_t *)((yp_if_node_t *)node)->predicate, buffer, include_location_fields);
            if (((yp_if_node_t *)node)->statements == NULL) {
                yp_buffer_append_u8(buffer, 0);
            } else {
                yp_serialize_node(parser, (yp_node_t *)((yp_if_node_t *)node)->statements, buffer, include_location_fields);
            }
            if (((yp_if_node_t *)node)->consequent == NULL) {
                yp_buffer_append_u8(buffer, 0);
            } else {
                yp_serialize_node(parser, (yp_node_t *)((yp_if_node_t *)node)->consequent, buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_IMAGINARY_NODE: {
            yp_serialize_node(parser, (yp_node_t *)((yp_imaginary_node_t *)node)->numeric, buffer, include_location_fields);
            break;
        }
        case YP_IN_NODE: {
            yp_serialize_node(parser, (yp_node_t *)((yp_in_node_t *)node)->pattern, buffer, include_location_fields);
            if (((yp_in_node_t *)node)->statements == NULL) {
                yp_buffer_append_u8(buffer, 0);
            } else {
                yp_serialize_node(parser, (yp_node_t *)((yp_in_node_t *)node)->statements, buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_INSTANCE_VARIABLE_AND_WRITE_NODE: {
            ...
            yp_serialize_node(parser, (yp_node_t *)((yp_instance_variable_and_write_node_t *)node)->value, buffer, include_location_fields);
            break;
        }
        case YP_INSTANCE_VARIABLE_OPERATOR_WRITE_NODE: {
            ...
            yp_serialize_node(parser, (yp_node_t *)((yp_instance_variable_operator_write_node_t *)node)->value, buffer, include_location_fields);
        ...
        case YP_INSTANCE_VARIABLE_OR_WRITE_NODE: {
            ...
            yp_serialize_node(parser, (yp_node_t *)((yp_instance_variable_or_write_node_t *)node)->value, buffer, include_location_fields);
            break;
        }
        ...
        case YP_INSTANCE_VARIABLE_WRITE_NODE: {
            ...
            yp_serialize_node(parser, (yp_node_t *)((yp_instance_variable_write_node_t *)node)->value, buffer, include_location_fields);
            if (include_location_fields) {
        ...
        case YP_INTERPOLATED_MATCH_LAST_LINE_NODE: {
            ...
            for (uint32_t index = 0; index < parts_size; index++) {
                yp_serialize_node(parser, (yp_node_t *) ((yp_interpolated_match_last_line_node_t *)node)->parts.nodes[index], buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_INTERPOLATED_REGULAR_EXPRESSION_NODE: {
            ...
            yp_buffer_append_u32(buffer, parts_size);
            for (uint32_t index = 0; index < parts_size; index++) {
                yp_serialize_node(parser, (yp_node_t *) ((yp_interpolated_regular_expression_node_t *)node)->parts.nodes[index], buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_INTERPOLATED_STRING_NODE: {
            ...
            yp_buffer_append_u32(buffer, parts_size);
            for (uint32_t index = 0; index < parts_size; index++) {
                yp_serialize_node(parser, (yp_node_t *) ((yp_interpolated_string_node_t *)node)->parts.nodes[index], buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_INTERPOLATED_SYMBOL_NODE: {
            ...
            yp_buffer_append_u32(buffer, parts_size);
            for (uint32_t index = 0; index < parts_size; index++) {
                yp_serialize_node(parser, (yp_node_t *) ((yp_interpolated_symbol_node_t *)node)->parts.nodes[index], buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_INTERPOLATED_X_STRING_NODE: {
            ...
            yp_buffer_append_u32(buffer, parts_size);
            for (uint32_t index = 0; index < parts_size; index++) {
                yp_serialize_node(parser, (yp_node_t *) ((yp_interpolated_x_string_node_t *)node)->parts.nodes[index], buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_KEYWORD_HASH_NODE: {
            ...
            yp_buffer_append_u32(buffer, elements_size);
            for (uint32_t index = 0; index < elements_size; index++) {
                yp_serialize_node(parser, (yp_node_t *) ((yp_keyword_hash_node_t *)node)->elements.nodes[index], buffer, include_location_fields);
            }
            break;
        }
        case YP_KEYWORD_PARAMETER_NODE: {
            ...
            if (((yp_keyword_parameter_node_t *)node)->value == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_keyword_parameter_node_t *)node)->value, buffer, include_location_fields);
            }
            break;
        }
        ...
        case YP_LAMBDA_NODE: {
            ...
            if (((yp_lambda_node_t *)node)->parameters == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_lambda_node_t *)node)->parameters, buffer, include_location_fields);
            }
            if (((yp_lambda_node_t *)node)->body == NULL) {
                yp_buffer_append_u8(buffer, 0);
            } else {
                yp_serialize_node(parser, (yp_node_t *)((yp_lambda_node_t *)node)->body, buffer, include_location_fields);
            }
            break;
        }
        case YP_LOCAL_VARIABLE_AND_WRITE_NODE: {
            ...
            yp_serialize_node(parser, (yp_node_t *)((yp_local_variable_and_write_node_t *)node)->value, buffer, include_location_fields);
        ...
        case YP_LOCAL_VARIABLE_OPERATOR_WRITE_NODE: {
            ...
            yp_serialize_node(parser, (yp_node_t *)((yp_local_variable_operator_write_node_t *)node)->value, buffer, include_location_fields);
        ...
        case YP_LOCAL_VARIABLE_OR_WRITE_NODE: {
            ...
            yp_serialize_node(parser, (yp_node_t *)((yp_local_variable_or_write_node_t *)node)->value, buffer, include_location_fields);
        ...
        case YP_LOCAL_VARIABLE_WRITE_NODE: {
            ...
            yp_serialize_node(parser, (yp_node_t *)((yp_local_variable_write_node_t *)node)->value, buffer, include_location_fields);
            if (include_location_fields) {
        ...
        case YP_MATCH_PREDICATE_NODE: {
            yp_serialize_node(parser, (yp_node_t *)((yp_match_predicate_node_t *)node)->value, buffer, include_location_fields);
            yp_serialize_node(parser, (yp_node_t *)((yp_match_predicate_node_t *)node)->pattern, buffer, include_location_fields);
            if (include_location_fields) {
        ...
        case YP_MATCH_REQUIRED_NODE: {
            yp_serialize_node(parser, (yp_node_t *)((yp_match_required_node_t *)node)->value, buffer, include_location_fields);
            yp_serialize_node(parser, (yp_node_t *)((yp_match_required_node_t *)node)->pattern, buffer, include_location_fields);
            if (include_location_fields) {
        ...
        case YP_MODULE_NODE: {
            ...
            yp_serialize_node(parser, (yp_node_t *)((yp_module_node_t *)node)->constant_path, buffer, include_location_fields);
            if (((yp_module_node_t *)node)->body == NULL) {
                yp_buffer_append_u8(buffer, 0);
            } else {
                yp_serialize_node(parser, (yp_node_t *)((yp_module_node_t *)node)->body, buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_MULTI_TARGET_NODE: {
            ...
            for (uint32_t index = 0; index < targets_size; index++) {
                yp_serialize_node(parser, (yp_node_t *) ((yp_multi_target_node_t *)node)->targets.nodes[index], buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_MULTI_WRITE_NODE: {
            ...
            yp_buffer_append_u32(buffer, targets_size);
            for (uint32_t index = 0; index < targets_size; index++) {
                yp_serialize_node(parser, (yp_node_t *) ((yp_multi_write_node_t *)node)->targets.nodes[index], buffer, include_location_fields);
            }
            if (include_location_fields) {
            ...
            yp_serialize_node(parser, (yp_node_t *)((yp_multi_write_node_t *)node)->value, buffer, include_location_fields);
            break;
        }
        case YP_NEXT_NODE: {
            if (((yp_next_node_t *)node)->arguments == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_next_node_t *)node)->arguments, buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_OPTIONAL_PARAMETER_NODE: {
            ...
            yp_serialize_node(parser, (yp_node_t *)((yp_optional_parameter_node_t *)node)->value, buffer, include_location_fields);
            break;
        }
        case YP_OR_NODE: {
            yp_serialize_node(parser, (yp_node_t *)((yp_or_node_t *)node)->left, buffer, include_location_fields);
            yp_serialize_node(parser, (yp_node_t *)((yp_or_node_t *)node)->right, buffer, include_location_fields);
            if (include_location_fields) {
        ...
        case YP_PARAMETERS_NODE: {
            ...
            yp_buffer_append_u32(buffer, requireds_size);
            for (uint32_t index = 0; index < requireds_size; index++) {
                yp_serialize_node(parser, (yp_node_t *) ((yp_parameters_node_t *)node)->requireds.nodes[index], buffer, include_location_fields);
            }
            ...
            for (uint32_t index = 0; index < optionals_size; index++) {
                yp_serialize_node(parser, (yp_node_t *) ((yp_parameters_node_t *)node)->optionals.nodes[index], buffer, include_location_fields);
            }
            if (((yp_parameters_node_t *)node)->rest == NULL) {
                yp_buffer_append_u8(buffer, 0);
            } else {
                yp_serialize_node(parser, (yp_node_t *)((yp_parameters_node_t *)node)->rest, buffer, include_location_fields);
            }
            uint32_t posts_size = yp_sizet_to_u32(((yp_parameters_node_t *)node)->posts.size);
            yp_buffer_append_u32(buffer, posts_size);
            for (uint32_t index = 0; index < posts_size; index++) {
                yp_serialize_node(parser, (yp_node_t *) ((yp_parameters_node_t *)node)->posts.nodes[index], buffer, include_location_fields);
            }
            ...
            for (uint32_t index = 0; index < keywords_size; index++) {
                yp_serialize_node(parser, (yp_node_t *) ((yp_parameters_node_t *)node)->keywords.nodes[index], buffer, include_location_fields);
            }
            if (((yp_parameters_node_t *)node)->keyword_rest == NULL) {
                yp_buffer_append_u8(buffer, 0);
            } else {
                yp_serialize_node(parser, (yp_node_t *)((yp_parameters_node_t *)node)->keyword_rest, buffer, include_location_fields);
            }
            if (((yp_parameters_node_t *)node)->block == NULL) {
                yp_buffer_append_u8(buffer, 0);
            } else {
                yp_serialize_node(parser, (yp_node_t *)((yp_parameters_node_t *)node)->block, buffer, include_location_fields);
            }
            break;
        }
        case YP_PARENTHESES_NODE: {
            if (((yp_parentheses_node_t *)node)->body == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_parentheses_node_t *)node)->body, buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_PINNED_EXPRESSION_NODE: {
            yp_serialize_node(parser, (yp_node_t *)((yp_pinned_expression_node_t *)node)->expression, buffer, include_location_fields);
            if (include_location_fields) {
        ...
        case YP_PINNED_VARIABLE_NODE: {
            yp_serialize_node(parser, (yp_node_t *)((yp_pinned_variable_node_t *)node)->variable, buffer, include_location_fields);
            if (include_location_fields) {
        ...
        case YP_POST_EXECUTION_NODE: {
            if (((yp_post_execution_node_t *)node)->statements == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_post_execution_node_t *)node)->statements, buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_PRE_EXECUTION_NODE: {
            if (((yp_pre_execution_node_t *)node)->statements == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_pre_execution_node_t *)node)->statements, buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_PROGRAM_NODE: {
            ...
            yp_serialize_node(parser, (yp_node_t *)((yp_program_node_t *)node)->statements, buffer, include_location_fields);
            break;
        }
        case YP_RANGE_NODE: {
            if (((yp_range_node_t *)node)->left == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_range_node_t *)node)->left, buffer, include_location_fields);
            }
            if (((yp_range_node_t *)node)->right == NULL) {
                yp_buffer_append_u8(buffer, 0);
            } else {
                yp_serialize_node(parser, (yp_node_t *)((yp_range_node_t *)node)->right, buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_RATIONAL_NODE: {
            yp_serialize_node(parser, (yp_node_t *)((yp_rational_node_t *)node)->numeric, buffer, include_location_fields);
            break;
        }
        case YP_REDO_NODE: {
            break;
        ...
        case YP_REQUIRED_DESTRUCTURED_PARAMETER_NODE: {
            ...
            for (uint32_t index = 0; index < parameters_size; index++) {
                yp_serialize_node(parser, (yp_node_t *) ((yp_required_destructured_parameter_node_t *)node)->parameters.nodes[index], buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_RESCUE_MODIFIER_NODE: {
            yp_serialize_node(parser, (yp_node_t *)((yp_rescue_modifier_node_t *)node)->expression, buffer, include_location_fields);
            if (include_location_fields) {
                yp_serialize_location(parser, &((yp_rescue_modifier_node_t *)node)->keyword_loc, buffer);
            }
            yp_serialize_node(parser, (yp_node_t *)((yp_rescue_modifier_node_t *)node)->rescue_expression, buffer, include_location_fields);
            break;
        }
        case YP_RESCUE_NODE: {
            if (include_location_fields) {
            ...
            for (uint32_t index = 0; index < exceptions_size; index++) {
                yp_serialize_node(parser, (yp_node_t *) ((yp_rescue_node_t *)node)->exceptions.nodes[index], buffer, include_location_fields);
            }
            if (include_location_fields) {
            ...
            if (((yp_rescue_node_t *)node)->reference == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_rescue_node_t *)node)->reference, buffer, include_location_fields);
            }
            if (((yp_rescue_node_t *)node)->statements == NULL) {
                yp_buffer_append_u8(buffer, 0);
            } else {
                yp_serialize_node(parser, (yp_node_t *)((yp_rescue_node_t *)node)->statements, buffer, include_location_fields);
            }
            if (((yp_rescue_node_t *)node)->consequent == NULL) {
                yp_buffer_append_u8(buffer, 0);
            } else {
                yp_serialize_node(parser, (yp_node_t *)((yp_rescue_node_t *)node)->consequent, buffer, include_location_fields);
            }
            break;
        }
        ...
        case YP_RETURN_NODE: {
            ...
            if (((yp_return_node_t *)node)->arguments == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_return_node_t *)node)->arguments, buffer, include_location_fields);
            }
            break;
        }
        case YP_SELF_NODE: {
        ...
        case YP_SINGLETON_CLASS_NODE: {
            ...
            yp_serialize_node(parser, (yp_node_t *)((yp_singleton_class_node_t *)node)->expression, buffer, include_location_fields);
            if (((yp_singleton_class_node_t *)node)->body == NULL) {
                yp_buffer_append_u8(buffer, 0);
            } else {
                yp_serialize_node(parser, (yp_node_t *)((yp_singleton_class_node_t *)node)->body, buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_SPLAT_NODE: {
            ...
            if (((yp_splat_node_t *)node)->expression == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_splat_node_t *)node)->expression, buffer, include_location_fields);
            }
            break;
        }
        case YP_STATEMENTS_NODE: {
            ...
            for (uint32_t index = 0; index < body_size; index++) {
                yp_serialize_node(parser, (yp_node_t *) ((yp_statements_node_t *)node)->body.nodes[index], buffer, include_location_fields);
            }
            break;
        }
        case YP_STRING_CONCAT_NODE: {
            yp_serialize_node(parser, (yp_node_t *)((yp_string_concat_node_t *)node)->left, buffer, include_location_fields);
            yp_serialize_node(parser, (yp_node_t *)((yp_string_concat_node_t *)node)->right, buffer, include_location_fields);
            break;
        }
        case YP_STRING_NODE: {
        ...
        case YP_SUPER_NODE: {
            ...
            if (((yp_super_node_t *)node)->arguments == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_super_node_t *)node)->arguments, buffer, include_location_fields);
            }
            if (include_location_fields) {
            ...
            if (((yp_super_node_t *)node)->block == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_super_node_t *)node)->block, buffer, include_location_fields);
            }
            break;
        }
        case YP_SYMBOL_NODE: {
        ...
        case YP_UNDEF_NODE: {
            ...
            for (uint32_t index = 0; index < names_size; index++) {
                yp_serialize_node(parser, (yp_node_t *) ((yp_undef_node_t *)node)->names.nodes[index], buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_UNLESS_NODE: {
            ...
            yp_serialize_node(parser, (yp_node_t *)((yp_unless_node_t *)node)->predicate, buffer, include_location_fields);
            if (((yp_unless_node_t *)node)->statements == NULL) {
                yp_buffer_append_u8(buffer, 0);
            } else {
                yp_serialize_node(parser, (yp_node_t *)((yp_unless_node_t *)node)->statements, buffer, include_location_fields);
            }
            if (((yp_unless_node_t *)node)->consequent == NULL) {
                yp_buffer_append_u8(buffer, 0);
            } else {
                yp_serialize_node(parser, (yp_node_t *)((yp_unless_node_t *)node)->consequent, buffer, include_location_fields);
            }
            if (include_location_fields) {
        ...
        case YP_UNTIL_NODE: {
            ...
            yp_serialize_node(parser, (yp_node_t *)((yp_until_node_t *)node)->predicate, buffer, include_location_fields);
            if (((yp_until_node_t *)node)->statements == NULL) {
                yp_buffer_append_u8(buffer, 0);
            } else {
                yp_serialize_node(parser, (yp_node_t *)((yp_until_node_t *)node)->statements, buffer, include_location_fields);
            }
            yp_buffer_append_u32(buffer, node->flags >> 1);
            break;
        }
        case YP_WHEN_NODE: {
            ...
            yp_buffer_append_u32(buffer, conditions_size);
            for (uint32_t index = 0; index < conditions_size; index++) {
                yp_serialize_node(parser, (yp_node_t *) ((yp_when_node_t *)node)->conditions.nodes[index], buffer, include_location_fields);
            }
            if (((yp_when_node_t *)node)->statements == NULL) {
                yp_buffer_append_u8(buffer, 0);
            } else {
                yp_serialize_node(parser, (yp_node_t *)((yp_when_node_t *)node)->statements, buffer, include_location_fields);
            }
            break;
        }
        case YP_WHILE_NODE: {
            ...
            yp_serialize_node(parser, (yp_node_t *)((yp_while_node_t *)node)->predicate, buffer, include_location_fields);
            if (((yp_while_node_t *)node)->statements == NULL) {
                yp_buffer_append_u8(buffer, 0);
            } else {
                yp_serialize_node(parser, (yp_node_t *)((yp_while_node_t *)node)->statements, buffer, include_location_fields);
            }
            yp_buffer_append_u32(buffer, node->flags >> 1);
            break;
        }
        ...
        case YP_YIELD_NODE: {
            ...
            if (((yp_yield_node_t *)node)->arguments == NULL) {
                ...
                yp_serialize_node(parser, (yp_node_t *)((yp_yield_node_t *)node)->arguments, buffer, include_location_fields);
            }
            if (include_location_fields) {
...
#line 192 "serialize.c.erb"
void
yp_serialize_content(yp_parser_t *parser, yp_node_t *node, yp_buffer_t *buffer, bool include_location_fields) {
    ...
    yp_serialize_node(parser, node, buffer, include_location_fields);
...
YP_EXPORTED_FUNCTION void
yp_parse_lex_serialize(const uint8_t *source, size_t size, yp_buffer_t *buffer, const char *metadata, bool include_location_fields) {
    yp_parser_t parser;
