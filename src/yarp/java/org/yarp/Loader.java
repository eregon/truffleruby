...
public class Loader {
    ...
    private ParseResult load() {
        ...
        expect((byte) 11, "YARP version does not match");
        expect((byte) 0, "YARP version does not match");

        expect((byte) 0, "Loader.java requires no location fields in the serialized output");
    ...
    private Nodes.Node loadNode() {
        ...
        switch (type) {
            ...
            case 19:
                return new Nodes.CallNode(loadOptionalNode(), (Nodes.ArgumentsNode) loadOptionalNode(), (Nodes.BlockNode) loadOptionalNode(), loadFlags(), loadString(), startOffset, length);
            case 20:
            ...
            case 129:
                return new Nodes.StringNode(loadOptionalLocation(), loadLocation(), loadString(), startOffset, length);
            case 130:
                return new Nodes.SuperNode((Nodes.ArgumentsNode) loadOptionalNode(), (Nodes.BlockNode) loadOptionalNode(), startOffset, length);
            case 131:
